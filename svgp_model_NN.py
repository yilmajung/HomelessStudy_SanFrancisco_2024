# Variational Nearest Neighbor Gaussian Process Model (VNNGP)
import json
import torch
import gpytorch
import numpy as np
...
def main(config):
    ...
    class GPModel(gpytorch.models.ApproximateGP):
        def __init__(self, inducing_points, likelihood, k=256, training_batch_size=256):
            ...
            variational_strategy = gpytorch.variational.NNVariationalStrategy(self, inducing_points, variational_distribution, k=k, training_batch_size=training_batch_size)
